    ...
    return (
        <a
            ...
            style={{
                ...
                padding: hovered ? '0.7rem 1.2rem 0.7rem 0.9rem' : '0.85rem',
                boxShadow: '0 6px 24px rgba(61,214,140,0.45)',
                textDecoration: 'none',
        ...
        >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="#0E1C36" style={{ flexShrink: 0 }}>
            ...
            {hovered && <span style={{ whiteSpace: 'nowrap' }}>Chat on WhatsApp</span>}
        </a>
    );
}
